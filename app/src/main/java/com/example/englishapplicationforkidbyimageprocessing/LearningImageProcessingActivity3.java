...
public class LearningImageProcessingActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learning_image_processing3);

        mWordStudyTextView = findViewById(R.id.study_text_view3);
        mNextButton = findViewById(R.id.next_button3);
        mEndButton = findViewById(R.id.end_button3);
        mButtonListen = findViewById(R.id.button_listen3);
...
//        showWords();
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LearningImageProcessingActivity3.this,Camera3Activity.class);
        ...
        mEndButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LearningImageProcessingActivity3.this,SelectCategoryActivity.class);
                startActivity(intent);
            }
        });
...
//        findViewById(R.id.button_speak_study3).setEnabled(false);
        findViewById(R.id.button_speak_study3).setVisibility(View.GONE);
        findViewById(R.id.text_view_speak3).setVisibility(View.GONE);
        mButtonListen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                findViewById(R.id.button_speak_study3).setVisibility(View.VISIBLE);
                findViewById(R.id.text_view_speak3).setVisibility(View.VISIBLE);
...
//                mGameHelper.addWordsSound(tempDestFile);
                ...
                findViewById(R.id.button_speak_study3).setBackgroundResource(R.drawable.mic_enable);
                findViewById(R.id.button_speak_study3).setEnabled(true);
            }
        });
...
//        final String path = Environment.getExternalStorageDirectory()+"/study_record_"+formatter.format(now)+".wav";
        ...
        findViewById(R.id.button_speak_study3).setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                findViewById(R.id.checkSoundImage3).setBackgroundResource(0);

                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    Toast.makeText(LearningImageProcessingActivity3.this, "กำลังบันทึกเสียง...", Toast.LENGTH_SHORT).show();
                    mRecorder = WavAudioRecorder.getInstanse();
                    mRecorder.setOutputFile(path);
                    try{
                        mRecorder.prepare();
...
//                        Toast.makeText(LearningImageProcessingActivity.this, "บันทึกเสียงเรียบร้อยเเล้ว", Toast.LENGTH_SHORT).show();
    ...
    private void showImage() {
        ...
        ImageView image = findViewById(R.id.study_image_view3);
        ...
        if(bm == null){
            Toast.makeText(LearningImageProcessingActivity3.this,"โหลดภาพไม่ขึ้น!!",Toast.LENGTH_SHORT).show();
        }
        try {
    ...
    private void processSpeechRecognize() {
        ...
        Ion.with(this)
                ...
                .setCallback(new FutureCallback<String>() {
                    ...
                    public void onCompleted(Exception e, String result) {
                        checkSound(result);
//                        Log.i("testt2","> "+result.trim()+" "+e.toString());
                    }
                });
    }
...
//        Toast.makeText(LearningImageProcessingActivity.this,"result: "+result.trim(),Toast.LENGTH_SHORT).show();
        ...
        if (text.trim().equalsIgnoreCase(result.trim())){
            findViewById(R.id.checkSoundImage3).setBackgroundResource(R.drawable.corret);
            mp = MediaPlayer.create(LearningImageProcessingActivity3.this,R.raw.correct_sound);
            mp.start();
        }else{
            findViewById(R.id.checkSoundImage3).setBackgroundResource(R.drawable.wrong);
            mp = MediaPlayer.create(LearningImageProcessingActivity3.this,R.raw.wrong_sound);
            mp.start();
        }
    }
