...
public class PlayingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLevel = findViewById(R.id.levelGame);
        mScore = findViewById(R.id.scorePlayer1);

        mEndButton.setButtonColor(getResources().getColor(R.color.orange));
        mEndButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PlayingActivity.this,SelectLearnPlayActivity.class);
                startActivity(intent);
            }
        });

        //Test Name
        mTestImageName = findViewById(R.id.image_text_view);
        mTestSoundName = findViewById(R.id.sound_text_view);

        mGameHelper = new GameDatabaseHelper(this);
        mNgrokHelper = new NgrokDatabaseHelper(this);

        //counter level
        mLevel.setText(Integer.toString(mCounter));
...
//                    Log.i("mCounter",Integer.toString(mCounter));
                    if(mCounter == 12){
//                        Toast.makeText(PlayingActivity.this,"next x = 10",Toast.LENGTH_SHORT).show();
                        mNextButton.setButtonColor(getResources().getColor(R.color.white));
                        Intent intent = new Intent(PlayingActivity.this,ScorePlayerActivity.class);
                        startActivity(intent);
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if (!recordTask.isCancelled() && recordTask.getStatus() == AsyncTask.Status.RUNNING) {
                        ...
                        Toast.makeText(PlayingActivity.this, "ไม่สามารถบันทึกเสียงได้!!", Toast.LENGTH_SHORT).show();
                    }
//                    uploadEngineSound();
...
//                    uploadUserSound();
    ...
    private void readDataFromDatabase() {
        Toast.makeText(PlayingActivity.this, "กำลังหาไฟล์จากดาต้าเบส...", Toast.LENGTH_LONG).show();
        ...
        for (WordsGame i : wordsGamesList) {
            //check Logcat for view message about add random folder
            String log = "Id: " + i.getId() + " ,Image: " + i.getImage() + " ,Sound: " + i.getSound() + " ,Score: " + i.getScore();
            Log.d("PlayingActivity", log);
            ...
            if (n == i.getId()) {
                ...
                new DownloadImageTask((ImageView) findViewById(R.id.game_player1_image_view))
                        .execute(i.getImage());

                Toast.makeText(PlayingActivity.this, "เเสดงรูป "+i.getSound(), Toast.LENGTH_LONG).show();
...
//        }
    ...
    private void addDataToDatabase() {
        ...
        Toast.makeText(PlayingActivity.this, "Inserting...", Toast.LENGTH_LONG).show();
...
//        Toast.makeText(this, wavFile.getAbsolutePath(), Toast.LENGTH_LONG).show();
    ...
    //====================================== CHECK SOUND AND UPLOAD SOUND ===================================================//

    private void uploadEngineSound(final String soundName){
//        Toast.makeText(getBaseContext(), "ระบบกำลังอัปโหลด uploadEngineSound...", Toast.LENGTH_LONG).show();

//        String nameSound = mGameHelper.getSoundPath();
        String path = (Environment.getExternalStorageDirectory()+"/"+soundName+".wav");

        mTestSoundName.setText(path);

        String url = "https://"+mNgrokHelper.getNgrokPath()+".ngrok.io"+"/wordsapp/sound/upload1.php";
        ...
        Ion.with(this)
                ...
                .setCallback(new FutureCallback<String>() {
                    ...
                    public void onCompleted(Exception e, String result) {
                        mTestImageName.setText(result);
                        Toast.makeText(getBaseContext(), "อัปโหลด TTS... เรียบร้อยเเล้ว", Toast.LENGTH_LONG).show();

                        //test count img
                        String img = Integer.toString(mCounterImage);
                        uploadUserSound(img);
                    }
                });
    }

    private void uploadUserSound(String img){
        Log.i("mCouterName",Integer.toString(mCounterImage));

        SimpleDateFormat formatter = new SimpleDateFormat("dd_MM_yyyy", Locale.KOREA);
        Date now = new Date();
        String path = (Environment.getExternalStorageDirectory()+"/"+"test_game_record_"+formatter.format(now)+".wav");

        mTestSoundName.setText(">"+path);

        String url = "https://"+mNgrokHelper.getNgrokPath()+".ngrok.io"+"/wordsapp/sound/upload2.php";
        Ion.with(this)
                .load(url)
                .setMultipartFile("upload_file", new File(path))
                .asString()
                .setCallback(new FutureCallback<String>() {
                    @Override
                    public void onCompleted(Exception e, String result) {
                        Toast.makeText(getBaseContext(), "อัปโหลด User... เรียบร้อยเเล้ว", Toast.LENGTH_LONG).show();
//                        processDTW();
                    }
                });
    }
    ...
    private void processDTW() {
        ...
        String url = "https://"+mNgrokHelper.getNgrokPath()+".ngrok.io"+"/wordsapp/sound/runSoundsGame.php";
        Ion.with(this)
                .load(url)
                .asString()
                .setCallback(new FutureCallback<String>() {
...
//                        textResult.setText(result);
    ...
    private void checkSound() {
        if(distance > 270){
            findViewById(R.id.check_sound_image_game).setBackgroundResource(R.drawable.wrong);
        }else{
            findViewById(R.id.check_sound_image_game).setBackgroundResource(R.drawable.corret);
        }
    }
