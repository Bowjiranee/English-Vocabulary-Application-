...
public class PlayingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEndButton = findViewById(R.id.end_button1);

        mLevel = findViewById(R.id.levelGame1);
...
//                    mTTS.setSpeechRate(1.5f);
    ...
    //====================================== SOUND ANSWER ===================================================//
        ...
        findViewById(R.id.button_speak_game1).setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    Toast.makeText(PlayingActivity.this, "กำลังบันทึกเสียง...", Toast.LENGTH_SHORT).show();
...
//        Log.i("getSoundtest",Integer.toString(qid));
    ...
    private void soundNextQuestion(int num){ //next question can save record order by 2,3,4 ...
        ...
        findViewById(R.id.button_speak_game1).setBackgroundResource(R.drawable.mic_enable);
        findViewById(R.id.button_speak_game1).setEnabled(true);
        findViewById(R.id.button_speak_game1).setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                findViewById(R.id.check_sound_image_game1).setBackgroundResource(0);
...
//                        Toast.makeText(PlayingActivity.this, "บันทึกเสียงเรียบร้อยเเล้ว", Toast.LENGTH_SHORT).show();
    ...
    private void uploadTTSSound(final View view) {  //send record_system
        ...
        Toast.makeText(PlayingActivity.this,"รอสักครู่นะคะ...",Toast.LENGTH_SHORT).show();
...
//        mTestImageName.setText("result "+result);
        ...
        if (mAnswer.equals(result.trim())){
            findViewById(R.id.check_sound_image_game1).setBackgroundResource(R.drawable.corret);
            scorePlayer++;
            mp = MediaPlayer.create(PlayingActivity.this,R.raw.correct_sound);
            mp.start();
        }else{
            findViewById(R.id.check_sound_image_game1).setBackgroundResource(R.drawable.wrong);
            mp = MediaPlayer.create(PlayingActivity.this,R.raw.wrong_sound);
            mp.start();
        }
...
//        Log.i("scorePlayer",mAnswer+"||"+result+" "+String.valueOf(scorePlayer));
        ...
        findViewById(R.id.button_speak_game1).setBackgroundResource(R.drawable.mic_disable);
        findViewById(R.id.button_speak_game1).setEnabled(false);
